...
#define FL_OBJECT_UNK_0x20 (1 << 5)                   // 0x20 - Unknown (Used in Mesh_Z)
#define FL_OBJECT_NO_DISPLAY (1 << 6)                 // 0x40 - Don't display the object
#define FL_OBJECT_SHADOW_VOLUME (1 << 7)              // 0x80 - Shadow volume mesh
#define FL_OBJECT_UNK_0x100 (1 << 8)                  // 0x100 - Unknown - Is used in MeshGC_Z::DrawWithMaterials (only when passed from the Skin) to decide whether to draw immediate or push a draw call
...
#define FL_OBJECT_IS_OMNI_UNK_SPHEREVSBOX_1 (1 << 25) // 0x2000000 - Unknown
#define FL_OBJECT_IS_OMNI_UNK_0x4000000 (1 << 26)     // 0x4000000 - Unknown
#define FL_OBJECT_IS_OMNI_SPOTLIGHT (1 << 27)         // 0x8000000 - Omni_Z is a spotlight (Used by Omni_Z)
#define FL_OBJECT_IS_OMNI_UNK_SPHEREVSBOX_2 (1 << 28) // 0x10000000 - Unknown
